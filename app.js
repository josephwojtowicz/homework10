...
const mainApp = () => {
  ...
  inquirer
    ...
    .then(response => {
      ...
      completeTeam.push(managerCardHtml);
      addTeamMembers();
    });
  ...
  const promptEngineer = () => {
    ...
    inquirer
      ...
      .then(response => {
        ...
        completeTeam.push(engineerCardHtml);
        addTeamMembers();
      });
  };
  ...
  const promptIntern = () => {
    ...
    inquirer
      ...
      .then(response => {
        ...
        completeTeam.push(internCardHtml);
        addTeamMembers();
      });
  };
  ...
  function createTeam() {
    ...
    const realTeam = completeTeam.join('');
    fs.writeFileSync(outputPath, mainHTML(realTeam), 'utf-8');
  }
};
